...
function Inventory() {
  ...
  const [newItem, setNewItem] = useState({
    name: '', sku: '', category: '', size: '', quantity: '', reorderPoint: '', costPrice: '', sellingPrice: ''
  });
  const [editItem, setEditItem] = useState(null);

  useEffect(() => {
    const initialInventory = [
      { id: 1, name: 'T-Shirt (Red)', sku: 'TS-001-R', category: 'Tops', size: 'M', quantity: 50, reorderPoint: 10, costPrice: 8.00, sellingPrice: 19.99 },
      { id: 2, name: 'Jeans (Blue)', sku: 'JN-002-B', category: 'Bottoms', size: '32', quantity: 30, reorderPoint: 5, costPrice: 25.00, sellingPrice: 59.99 },
      { id: 3, name: 'Hoodie (Gray)', sku: 'HD-003-G', category: 'Outerwear', size: 'L', quantity: 25, reorderPoint: 8, costPrice: 18.00, sellingPrice: 44.99, },
      { id: 4, name: 'Dress (Floral)', sku: 'DR-004-F', category: 'Dresses', size: 'S', quantity: 40, reorderPoint: 12, costPrice: 15.00, sellingPrice: 39.99,  },
      { id: 5, name: 'Shorts (Khaki)', sku: 'SH-005-K', category: 'Bottoms', size: '34', quantity: 20, reorderPoint: 6, costPrice: 12.00, sellingPrice: 29.99, },
      { id: 6, name: 'Sweater (Navy)', sku: 'SW-006-N', category: 'Tops', size: 'M', quantity: 35, reorderPoint: 10, costPrice: 20.00, sellingPrice: 49.99, },
      { id: 7, name: 'Skirt (Black)', sku: 'SK-007-BK', category: 'Bottoms', size: '8', quantity: 28, reorderPoint: 7, costPrice: 10.00, sellingPrice: 24.99,  },
      { id: 8, name: 'Jacket (Denim)', sku: 'JK-008-D', category: 'Outerwear', size: 'L', quantity: 15, reorderPoint: 4, costPrice: 30.00, sellingPrice: 69.99,  },
      { id: 9, name: 'Blouse (White)', sku: 'BL-009-W', category: 'Tops', size: 'S', quantity: 42, reorderPoint: 11, costPrice: 14.00, sellingPrice: 34.99,   },
      { id: 10, name: 'Trousers (Gray)', sku: 'TR-010-G', category: 'Bottoms', size: '36', quantity: 22, reorderPoint: 6, costPrice: 16.00, sellingPrice: 39.99, },
  ...
  const handleAddItem = () => {
    if (newItem.name && newItem.sku) {
      ...
      setNewItem({ name: '', sku: '', category: '', size: '', quantity: '', reorderPoint: '', costPrice: '', sellingPrice: '' });
    }
  };
